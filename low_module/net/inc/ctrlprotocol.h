...
//协议
#define CTRL_PROTOCOL_SERVERPORT		8670//6630					//服务器端口 6610
#define CTRL_PROTOCOL_MAXLINKNUM		16
...
#define CTRL_ACK						2
#define CTRL_SOCKET_IO_TIMEOUT			3		//send & recv 超时时间(秒)
...
typedef struct 
{
	...
	u8	maxHddNum;						//最大硬盘数
	u8	nNVROrDecoder;	//跃天: 1 nvr，2 轮巡解码器，3 切换解码器，4 网络键盘
	u8	reserved[15];					//预留
}ifly_DeviceInfo_t;
