...
public:
    ...
    void setupUi(QWidget *page_config)
    {
        ...
        if (tableWidget_tvWall->columnCount() < 4)
            tableWidget_tvWall->setColumnCount(4);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        tableWidget_tvWall->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        tableWidget_tvWall->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        tableWidget_tvWall->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        tableWidget_tvWall->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        ...
        QWidget::setTabOrder(btn_tvWall_add, btn_tvWall_del);
        QWidget::setTabOrder(btn_tvWall_del, tableWidget_tvWall);
    ...
    void retranslateUi(QWidget *page_config)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem = tableWidget_tvWall->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("page_config", "\345\272\217\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget_tvWall->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("page_config", "\347\212\266\346\200\201", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget_tvWall->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("page_config", "\345\220\215\347\247\260", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget_tvWall->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("page_config", "\346\217\217\350\277\260", 0, QApplication::UnicodeUTF8));
