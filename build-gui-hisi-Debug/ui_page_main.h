...
public:
    ...
    void setupUi(QDialog *page_main)
    {
        if (page_main->objectName().isEmpty())
            page_main->setObjectName(QString::fromUtf8("page_main"));
        page_main->resize(1024, 768);
        page_main->setSizeGripEnabled(false);
        verticalLayout = new QVBoxLayout(page_main);
        verticalLayout->setSpacing(0);
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        widget_title = new QWidget(page_main);
        ...
        widget_main = new QWidget(page_main);
        ...
        retranslateUi(page_main);

        QMetaObject::connectSlotsByName(page_main);
    } // setupUi

    void retranslateUi(QDialog *page_main)
    {
        page_main->setWindowTitle(QApplication::translate("page_main", "Dialog", 0, QApplication::UnicodeUTF8));
        lab_ico->setText(QString());
        lab_title->setText(QString());
        btn_preview->setText(QApplication::translate("page_main", "\351\242\204\350\247\210", 0, QApplication::UnicodeUTF8));
        btn_playback->setText(QApplication::translate("page_main", "\345\233\236\346\224\276", 0, QApplication::UnicodeUTF8));
        btn_tvWall->setText(QApplication::translate("page_main", "\347\224\265\350\247\206\345\242\231", 0, QApplication::UnicodeUTF8));
        btn_alarm->setText(QApplication::translate("page_main", "\346\212\245\350\255\246\347\256\241\347\220\206", 0, QApplication::UnicodeUTF8));
        btn_device->setText(QApplication::translate("page_main", "\350\256\276\345\244\207\347\256\241\347\220\206", 0, QApplication::UnicodeUTF8));
        btn_config->setText(QApplication::translate("page_main", "\347\263\273\347\273\237\350\256\276\347\275\256", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class page_main: public Ui_page_main {};
} // namespace Ui
