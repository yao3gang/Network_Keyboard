...
public:
    ...
    void setupUi(QWidget *page_main)
    {
    ...
    void retranslateUi(QWidget *page_main)
    {
        page_main->setWindowTitle(QApplication::translate("page_main", "Form", 0, QApplication::UnicodeUTF8));
